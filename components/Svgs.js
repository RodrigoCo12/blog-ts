const Svgs = ({ name, className, onClick, filter }) => {
  const svgs = {
    ...
    logo_shadow: (
      <svg className={className} width="141" height="83" viewBox="0 0 141 83">
        <g filter="url(#filter0_d_330_310)">
          ...
          <path
            d="M67.0055 22.5C67.0055 26.6421 63.6477 30 59.5055 30C55.3634 30 53.8971 27.9881 54.0056 27.5C55.0056 23 57.0056 18.5 63.0055 15.5C63.1109 15.4473 67.0055 18.3579 67.0055 22.5Z"
            fill="white"
          />
        </g>
        <defs>
    ...
    chain: (
      <svg className={className} width="15" height="49" viewBox="0 0 15 49">
        <path
    ...
    fileClose: (
      <svg className={className} width="40" height="36" viewBox="0 0 49 40">
    ...
    fileOpen: (
      <svg className={className} width="48" height="36" viewBox="0 0 58 40">
    ...
    gmail: (
      <svg className={className} width="38" height="30" viewBox="0 0 38 30">
        <path d="M33.75 26.25H30V9.84375L18.75 16.875L7.5 9.84375V26.25H3.75V3.75H6L18.75 11.7188L31.5 3.75H33.75M33.75 0H3.75C1.66875 0 0 1.66875 0 3.75V26.25C0 27.2446 0.395088 28.1984 1.09835 28.9016C1.80161 29.6049 2.75544 30 3.75 30H33.75C34.7446 30 35.6984 29.6049 36.4016 28.9016C37.1049 28.1984 37.5 27.2446 37.5 26.25V3.75C37.5 2.75544 37.1049 1.80161 36.4016 1.09835C35.6984 0.395088 34.7446 0 33.75 0Z" />
      </svg>
    ),
    twitter: (
      <svg className={className} width="37" height="30" viewBox="0 0 37 30">
        <path d="M36.9033 3.55855C35.5462 4.1599 34.0883 4.56621 32.5557 4.74987C34.1371 3.80363 35.3202 2.31435 35.8842 0.559934C34.3985 1.44244 32.7724 2.06362 31.0767 2.39648C29.9364 1.17894 28.426 0.371933 26.78 0.100754C25.1341 -0.170425 23.4446 0.109396 21.974 0.896774C20.5033 1.68415 19.3338 2.93503 18.6469 4.45521C17.96 5.97539 17.7943 7.67981 18.1753 9.30386C15.1648 9.1527 12.2198 8.37022 9.53125 7.00721C6.84273 5.64419 4.47085 3.73109 2.56954 1.39207C1.91944 2.5135 1.54563 3.81371 1.54563 5.19844C1.5449 6.44501 1.85188 7.67249 2.43933 8.77196C3.02677 9.87144 3.87652 10.8089 4.91318 11.5012C3.71093 11.463 2.53521 11.1381 1.48387 10.5537V10.6512C1.48375 12.3996 2.08852 14.0941 3.19557 15.4474C4.30262 16.8006 5.84376 17.7291 7.55748 18.0754C6.4422 18.3773 5.27291 18.4217 4.13793 18.2054C4.62144 19.7098 5.56328 21.0253 6.83159 21.9678C8.0999 22.9103 9.63119 23.4326 11.2111 23.4615C8.52912 25.5669 5.21692 26.709 1.80729 26.7039C1.20332 26.7041 0.599847 26.6688 0 26.5983C3.46096 28.8236 7.48978 30.0046 11.6044 30C25.5329 30 33.1473 18.4639 33.1473 8.45872C33.1473 8.13367 33.1392 7.80537 33.1245 7.48031C34.6056 6.40922 35.8841 5.08288 36.9 3.56342L36.9033 3.55855Z" />
      </svg>
    ),
    github: (
    ...
    tag: (
      <svg className={className} width="29" height="29" viewBox="0 0 29 29">
        <path d="M6.51984 7.95C7.30961 7.95 7.94984 7.30976 7.94984 6.52C7.94984 5.73023 7.30961 5.09 6.51984 5.09C5.73008 5.09 5.08984 5.73023 5.08984 6.52C5.08984 7.30976 5.73008 7.95 6.51984 7.95Z" />
        <path d="M27.93 15.2L13.33 0.6C13.146 0.412213 12.9267 0.262561 12.6847 0.159606C12.4428 0.0566516 12.1829 0.00241487 11.92 0H2C1.46957 0 0.960859 0.210714 0.585786 0.585786C0.210714 0.960859 0 1.46957 0 2V11.92C0.00223279 12.4496 0.214412 12.9566 0.59 13.33L15.19 27.93C15.3757 28.116 15.5963 28.2635 15.8391 28.3641C16.0819 28.4648 16.3422 28.5166 16.605 28.5166C16.8678 28.5166 17.1281 28.4648 17.3709 28.3641C17.6137 28.2635 17.8343 28.116 18.02 27.93L27.92 18.03C28.1066 17.8449 28.2549 17.6249 28.3564 17.3824C28.4579 17.14 28.5106 16.8799 28.5116 16.6171C28.5125 16.3542 28.4616 16.0938 28.3618 15.8507C28.262 15.6075 28.1153 15.3864 27.93 15.2ZM16.62 26.52L2 11.91V2H11.92L26.52 16.62L16.62 26.52Z" />
      </svg>
    ),
    back: (
      <svg className={className} width="31" height="30" viewBox="0 0 31 30">
        <path
          fillRule="evenodd"
          clipRule="evenodd"
          d="M12.2732 1.3648C12.2734 1.08042 12.1848 0.803083 12.0196 0.571591C11.8544 0.340099 11.621 0.166039 11.352 0.0737703C11.083 -0.0184983 10.7919 -0.0243585 10.5194 0.05701C10.2469 0.138378 10.0067 0.302904 9.83237 0.527561L0.287298 12.7998C0.101095 13.0392 0 13.3338 0 13.637C0 13.9403 0.101095 14.2349 0.287298 14.4743L9.83237 26.7465C10.0067 26.9712 10.2469 27.1357 10.5194 27.2171C10.7919 27.2984 11.083 27.2926 11.352 27.2003C11.621 27.108 11.8544 26.934 12.0196 26.7025C12.1848 26.471 12.2734 26.1936 12.2732 25.9093V20.4686C19.6079 20.6213 23.1314 22.0135 24.9013 23.5271C26.584 24.9657 26.8921 26.6579 27.2126 28.4305L27.2958 28.8873C27.3569 29.2142 27.5355 29.5074 27.7977 29.7119C28.06 29.9163 28.388 30.0179 28.7199 29.9974C29.0518 29.977 29.3648 29.836 29.6 29.6009C29.8352 29.3658 29.9764 29.0529 29.997 28.721C30.2302 24.9739 29.8797 19.5441 27.233 15.002C24.664 10.5935 20.0374 7.20366 12.2732 6.84912V1.3648Z"
        />
      </svg>
    ),
  }
